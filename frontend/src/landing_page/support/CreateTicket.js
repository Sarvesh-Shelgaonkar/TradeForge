    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Margin/leverage,Product and Order
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Kite Web and Mobile
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5 text-muted mb-5 ">
            <i class="fa fa-credit-card-alt fs-5 me-2" aria-hidden="true"></i>
            Funds
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Adding Funds
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5 text-muted mb-5">
            <i class="fa fa-circle-o-notch me-2" aria-hidden="true"></i>Console
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Reports
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5 text-muted mb-5 ">
            <i class="fa fa-circle-thin fs-5 me-2" aria-hidden="true"></i>
            Coin
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
